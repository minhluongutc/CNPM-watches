...
export class RegisterComponent implements OnInit {
    ...
    this.signupForm = this.formBuilder.group(
      {
        ...
        'firstName': new FormControl('', [Validators.required, Validators.pattern('^[a-zA-ZÀ-Ỹà-ỹ ]+$')]),
        'lastName': new FormControl('', [Validators.required, Validators.pattern('^[a-zA-ZÀ-Ỹà-ỹ ]+$')]),
  ...
  onSubmit() {
    console.log(this.firstName?.getRawValue())
